...
uses
 blcksock,ares_types,classes,classes2,sysutils,windows,
 const_win_messages,forms;
...
uses
 ...
 helper_datetime,ufrmpvt,ufrmmain,const_ares,const_privchat,const_commands_privatechat,
...
begin
          ...
          str:=str+CHRNULL+
             ...
             if ares_frmmain.check_opt_chat_browsable.checked then begin
               str:=str+CHRNULL+
                        CHRNULL+CHRNULL+
