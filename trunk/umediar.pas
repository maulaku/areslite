...
uses
 Classes, SysUtils, utility_ares,windows,helper_unicode,helper_diskio,helper_strings,ares_types,
 TntSysUtils,  DirectDraw, Directshow9, Dspack,olectrls,SyncObjs,comobj,ShlObj,graphics,forms,tntwindows;
...
function MyGetModuleFileNameW(hModule: HINST; lpFilename: PWideChar; nSize: DWORD): widestring;
begin
  if Win32PlatformIsUnicode then GetModuleFileNameW{TNT-ALLOW GetModuleFileNameW}(hModule, lpFilename, nSize)
  else begin
