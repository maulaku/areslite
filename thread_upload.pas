...
uses
  ufrmmain, ufrmpvt, helper_unicode, vars_localiz, helper_crypt, helper_strings, helper_base64_32,
  helper_diskio, helper_sockets, helper_ipfunc, helper_urls, helper_sorting, const_udpTransfer,
  helper_registry, vars_global, helper_datetime, helper_private_chat, mysupernodes, secureHash,
...
begin
  ...
  vars_global.block_pvt_chat := ares_frmmain.Check_opt_chat_nopm.checked;
  loc_block_pvt_chat := ares_frmmain.Check_opt_chat_nopm.checked;
  vars_global.block_pm := ares_frmmain.Check_opt_chatroom_nopm.checked;
  ...
  if ((ares_frmmain.check_opt_tran_inconidle.checked) and
...
begin
  ...
  ares_frmmain.edit_opt_tran_port.text := inttostr(vars_global.myport);

  if pos(':', ares_frmmain.edit_opt_chat_connect.text) = 0 then
    ares_frmmain.edit_opt_chat_connect.text := '127.0.0.1:' + inttostr(vars_global.myport);
end;
...
begin
  try
    ...
    if vars_global.cache_server <> nil then begin //unreachable by flood or problems
      socket_globale.free;
      exit;
    end;
...
begin
  ...
  amountpercycle := tot_amount_tosend div cardinal(lista_upload.count);
